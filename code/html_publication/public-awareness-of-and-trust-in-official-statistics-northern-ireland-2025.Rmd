...
percent_weighted_df$option_wrapped <- wrap_label(percent_weighted_df$option, width = 30)
...
plot_ly(
  ...
  texttemplate = "<b>%{x:.0f}</b>",
  cliponaxis = FALSE,
  hovertext = ~paste0(option, ": ", round_half_up(percent_weighted), "%"),
  hoverinfo = "text"
) %>%
  layout(font = list(family = "Arial", size = 12),
         bargap = 0.45,
...
percent_weighted_distrust_df$option_wrapped <- wrap_label(percent_weighted_distrust_df$option, width = 30)
