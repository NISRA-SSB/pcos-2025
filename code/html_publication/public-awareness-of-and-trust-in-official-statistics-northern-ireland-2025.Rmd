...
Respondents who indicated that they trust NISRA statistics were asked their reasons for doing so and could select up to three reasons from a predetermined list (Chart 9.1). The most frequently chosen reasons were that official statistics in Northern Ireland are generally accurate (`r Reasons_trust_accurate`%), that they trust the statistics from a personal experience (`r Reasons_trust_experience`%) and that NISRA does not have a vested interest in or manipulate the figures (`r Reasons_trust_nisra_vested`%).  

#### Chart 9.1: Reasons for trusting NISRA statistics, `r current_year`
...
Similarly, respondents who indicated they do not trust NISRA statistics were asked their reasons for not doing so (chart 9.2). The reason most frequently chosen by respondents was that the statistics alone do not tell the whole story (`r Reasons_distrust_story`%). The next most common reason given was that Government departments have a vested interest in or manipulate the figures (`r Reasons_distrust_gov_vested`%).  

#### Chart 9.2: Reasons for distrusting NISRA statistics, `r current_year`

```{r Chart 9.2, fig.alt = "Vertical bar chart, Reasons for distrusting NISRA.", fig.height=7}
...
The percentage of respondents agreeing that NISRA statistics are important to understand Northern Ireland in 2025 is not significantly different than in 2022 to 2024 but is lower than earlier years (2020 and 2021) (Chart 10).
...
Agreement that NISRA statistics are free from political interference is not significantly different than in 2021 to 2024 but lower than in 2020 (88%). However, when only those respondents who expressed an opinion are considered, agreement has increased since 2023 and 2024 and is similar to that in 2020 to 2022. 
...
Ninety-one percent of respondents (`r agree_confidential`%) agree that personal information provided to NISRA will be kept confidential while `r disagree_confidential`% disagree. The remaining respondents 'don’t know' (`r dont_know_confidential`%) (Chart 14).
...
In comparison, `r agree_confidential_ons`% of ONS respondents in `r ons_year` (the latest available data) agree that personal information provided to ONS will be kept confidential. This is significantly lower than for NISRA (Chart 15).
