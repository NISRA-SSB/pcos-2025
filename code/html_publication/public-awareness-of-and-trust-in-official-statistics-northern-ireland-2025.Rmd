...
```{r Chart 9.1, fig.alt = "Vertical bar chart, Reasons for trusting NISRA.", fig.height=7}
...
f_extract_sheet(path = xl_filename,
  ...
  sheet_title = paste0("Table 4.1a: Reasons for Trusting NISRA in ", current_year))
...
```{r Chart 9.2, fig.alt = "Vertical bar chart, Reasons for distrusting NISRA.", fig.height=8}
...
f_extract_sheet(path = xl_filename,
  ...
  sheet_title = paste0("Table 4.2a: Reasons for Distrusting NISRA in ", current_year))
