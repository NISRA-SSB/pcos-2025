...
* `r f_embed_ods(df = table_2.1j_data, sheet_title = paste0("Table 2.1j: Number of selected NISRA statistics respondents had heard of, ", current_year), tab_name = "aware_num_stats", app_b = TRUE)`
...
* `r f_embed_ods(df = table_4.1a_data, sheet_title = paste0("Table 4.1a: Reasons for trusting NISRA statistics, ", current_year), tab_name = "reasons_trust", app_b = TRUE)`
* `r f_embed_ods(df = table_4.2a_data, sheet_title = paste0("Table 4.2a: Reasons for distrusting NISRA statistics, ", current_year), tab_name = "reasons_distrust", app_b = TRUE)`
...
* `r f_embed_ods(df = table_5c_data, sheet_title = paste0("Table 5c: Statistics produced by NISRA are important to understand Northern Ireland, ", current_year), tab_name = "trust_stats_awareness", app_b = TRUE)`
