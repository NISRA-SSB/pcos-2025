...
* `r f_embed_ods(df = table_4.1a_data, sheet_title = paste0("Table 4.1a: Reasons for Trusting NISRA in ", current_year), tab_name = "reasons_trust", app_b = TRUE)`
* `r f_embed_ods(df = table_4.2a_data, sheet_title = paste0("Table 4.2a: Reasons for Distrusting NISRA in ", current_year), tab_name = "reasons_distrust", app_b = TRUE)`
