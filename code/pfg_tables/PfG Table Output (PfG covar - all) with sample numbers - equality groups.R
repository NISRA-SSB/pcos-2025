...
for (question in questions) {
  ...
  add_suppression_note(wb, question, nrow(question_data_rounded))
...
xl_filename <- paste0(here(), "/outputs/PfG/PfG - Equality Groups Data (pfg covariates) with sample numbers (all covar) ", current_year, ".xlsx")
